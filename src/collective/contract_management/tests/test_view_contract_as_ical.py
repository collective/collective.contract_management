...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_contract_as_ical_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='contract-as-ical'
        )
        self.assertTrue(view.__name__ == 'contract-as-ical')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in contract-as-ical'
        # )

    def test_contract_as_ical_not_matching_interface(self):
